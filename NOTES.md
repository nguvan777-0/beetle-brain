...
────────────────────────────────────────────────────────────
  lineage 7   born tick      0  share 29%  final 557
               size 8.15  speed 1.86  pred 1.60  n_rays 4.1  neurons 11
  lineage 1   born tick      0  share  8%  final   1
  lineage 64  born tick  6,000  share  7%  final 165
               size 8.14  speed 1.96  pred 1.61  n_rays 4.0  neurons 11
  lineage 83  born tick  8,000  share  6%  final 146
               size 8.14  speed 1.98  pred 1.60  n_rays 4.0  neurons 11
  lineage 574 born tick 10,000  share  4%  final  92
               size 8.12  speed 1.99  pred 1.59  n_rays 4.0  neurons 12

────────────────────────────────────────────────────────────
  strategy spread — tight cluster, monoculture
────────────────────────────────────────────────────────────
...
![screenshot](https://github.com/nguvan777-0/beetle-brain/releases/download/screenshots/screenshot_a787e90_753463_0007937.png)
